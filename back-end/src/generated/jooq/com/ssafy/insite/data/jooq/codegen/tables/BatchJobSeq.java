...
public class BatchJobSeq extends TableImpl<BatchJobSeqRecord> {
    ...
    /**
     * The reference instance of <code>s13p21e203.batch_job_seq</code>
     */
    ...
    /**
     * The column <code>s13p21e203.batch_job_seq.my_row_id</code>.
     */
    public final TableField<BatchJobSeqRecord, ULong> MY_ROW_ID = createField(DSL.name("my_row_id"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>s13p21e203.batch_job_seq.ID</code>.
     */
    public final TableField<BatchJobSeqRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>s13p21e203.batch_job_seq.UNIQUE_KEY</code>.
     */
    ...
    /**
     * Create an aliased <code>s13p21e203.batch_job_seq</code> table reference
     */
    ...
    /**
     * Create a <code>s13p21e203.batch_job_seq</code> table reference
     */
    public BatchJobSeq() {
    ...
    @Override
    public UniqueKey<BatchJobSeqRecord> getPrimaryKey() {
        return Keys.KEY_BATCH_JOB_SEQ_PRIMARY;
    }
